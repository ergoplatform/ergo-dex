...
import org.ergoplatform.appkit.ergotool.dex.{CreateBuyOrderCmd, CreateSellOrderCmd, IssueTokenCmd, ListMatchingOrdersCmd, MatchOrdersCmd}
...
object ErgoTool {
  ...
  val commands: Map[String, CmdDescriptor] = Array(
    ...
    CreateSellOrderCmd, CreateBuyOrderCmd, MatchOrdersCmd, ListMatchingOrdersCmd, IssueTokenCmd
